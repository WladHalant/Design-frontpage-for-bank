...
<nav class="navbar navbar-expand-lg navbar-light bg-danger text-white mt-3 rounded mybtn">
  <a href="#" class="lin">Вернуться<br><img class="navbar-brand" src="assets/icons/logo.png"></a><br>
...
document.write(net.ComputerName);
  ...
  <div class="row mx-auto">
    ...
    <div class="col-sm-3 m-0">
      <a class="tile purple m-1 p-3 rounded mybtn text-center " href="http://servicedesk.homecredit.ru" target="_blank">
  ...
  <div class="row mx-auto">
    ...
    <div class="col-sm-3 m-0">
      <a class="tile red m-1 p-3 rounded mybtn text-center" href="http://salesportal.homecredit.ru" target="_blank">
  ...
  <div class="row mx-auto">
    ...
    <div class="col-sm-3 m-0">
      <a class="tile green m-1 p-3 rounded mybtn text-center" href="https://da.kreditotdel.ru" target="_blank">

        <img class="icon" src="assets/icons/da.png" alt="" />
        <div class="row"><div class="col-sm-12  m-0 text-center">Всегда Да</div></div>
      </a>
    </div>
    <div class="col-sm-3 m-0">
      <a class="tile orange m-1 p-3 rounded mybtn text-center" href="https://da2.kreditotdel.ru/login" target="_blank">

        <img class="icon" src="assets/icons/da2.png" alt="" />
        <div class="row"><div class="col-sm-12  m-0 text-center">Всегда Да 2.0</div></div>
      </a>
    </div>
  </div>
  <div class="row mx-auto">
    ...
    <div class="col-sm-3 m-0">
      <a class="tile red m-1 p-3 rounded mybtn text-center" href="https://e-learning.homecredit.ru" target="_blank">
  ...
  <div class="row mx-auto">
    ...
    <div class="col-sm-3 m-0">
      <a class="tile ared m-1 p-3 rounded mybtn text-center" href="https://налоговыйвычет.онлайн/" target="_blank">
        ...
        <div class="row"><div class="col-sm-12  m-0 text-center">НДФЛка.ру</div></div>
      </a>
    </div>
  </div>
</div>
